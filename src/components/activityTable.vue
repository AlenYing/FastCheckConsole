<template>
    <div class="Block">
            ...
            <div class="TableBlock">
                <table>
                    ...
                    <tr v-for="(activity,index) in activityTable" :key="activity">
                        ...
                        <th class="operation">
                            <div class="operationBtn" style="background-color:#a1dd70;">开始签到</div>
        ...
        <div :class="{master:showUpWindow}"></div>
        <upWindow :class="[showUpWindow? showWindow : unShow ,aniDis]" @close-window="closewindow"
